    ...
    <section id="team" className="py-20 bg-primary-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold font-heading tracking-wide text-primary-dark mb-4">MEET OUR TEAM.</h2>
          ...
          {team.map((member, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              <img 
                ...
                alt={member.name} 
              />
              <h3 className="text-xl font-bold font-subheading text-primary-dark">{member.name}</h3>
