        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Building the future with code. We transform ideas into powerful digital solutions.
            </p>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-white">Services</h4>
             <ul className="space-y-3">
              ...
              <li><a href="#services" className="text-gray-400 hover:text-accent-blue transition">Cloud Solutions</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-accent-blue transition">AI Solutions</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">hello@bergybit.com</span>
              </li>
              <li className="flex items-start">
